...
const (
	...
	CTXKeyAuthenticated ctxKey = "github.com/SecureAuthCorp/gokrb5/CTXKeyAuthenticated"
	// CTXKeyCredentials is the request context key holding the credentials gopkg.in/jcmturner/goidentity.v2/Identity object.
	CTXKeyCredentials ctxKey = "github.com/SecureAuthCorp/gokrb5/CTXKeyCredentials"
